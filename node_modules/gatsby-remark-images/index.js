...
module.exports = function (_ref, pluginOptions) {
  ...
  var getImageCaption = function getImageCaption(node, alt, defaultAlt) {
  ...
  function () {
    ...
    _regenerator.default.mark(function _callee(node, resolve, inLink, overWrites) {
      var parentNode, imagePath, imageNode, fluidResult, originalImg, fallbackSrc, srcSet, presentationWidth, srcSplit, fileName, fileNameNoExt, defaultAlt, alt, title, imageTag, webpFluidResult, placeholderImageData, args, _require3, Potrace, argsKeys, tracedSVG, ratio, wrapperStyle, imageCaption, rawHTML;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 15:
              ...
              title = node.title ? node.title : alt; // Create our base image tag
            ...
            case 43:
              ...
              imageCaption = options.showCaptions && getImageCaption(node, alt, defaultAlt);
