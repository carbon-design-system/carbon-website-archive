...
export default (function (props) {
  return React.createElement(DataTable, _extends({
    ...
    render: function render(_ref) {
      ...
      }, React.createElement(Table, getTableProps(), React.createElement(TableHead, null, React.createElement(TableRow, null, React.createElement(TableExpandHeader, null), headers.map(function (header) {
