  ...
  _createClass(SideNavMenu, [{
    ...
    value: function render() {
      ...
      if (children && _typeof(children) === Object) {
        hasActiveChild = children.some(function (child) {
      ...
      var className = cx((_cx = {}, _defineProperty(_cx, "".concat(prefix, "--side-nav__item"), true), _defineProperty(_cx, "".concat(prefix, "--side-nav__item--active"), isActive || hasActiveChild && !isExpanded), _defineProperty(_cx, "".concat(prefix, "--side-nav__item--icon"), IconElement), _defineProperty(_cx, customClassName, !!customClassName), _cx));
