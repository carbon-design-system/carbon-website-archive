...
export default function PasswordInput(_ref) {
  ...
  var alt = _ref.alt,
      ...
      light = _ref.light,
      other = _objectWithoutProperties(_ref, ["alt", "labelText", "className", "id", "placeholder", "onChange", "onClick", "hideLabel", "invalid", "invalidText", "helperText", "light"]);
  ...
  var input = React.createElement(React.Fragment, null, React.createElement("input", _extends({}, textInputProps({
    ...
    className: "".concat(prefix, "--text-input--password__visibility"),
