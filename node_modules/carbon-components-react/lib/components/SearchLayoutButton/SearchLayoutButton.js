    ...
    value: function render() {
      ...
      var SearchLayoutButtonIcon = function SearchLayoutButtonIcon() {
        if (_this2.state.format === 'list') {
          return _react.default.createElement(_iconsReact.ListBulleted16, {
            className: "".concat(prefix, "--search-view"),
            "aria-label": iconDescriptionList
          });
        }

        return _react.default.createElement(_iconsReact.Grid16, {
          className: "".concat(prefix, "--search-view"),
      ...
      }, _react.default.createElement(SearchLayoutButtonIcon, null)));
    }
  }], [{
