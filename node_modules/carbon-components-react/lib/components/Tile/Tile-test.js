...
describe('Tile', function () {
  ...
  describe('Renders expandable tile as expected', function () {
    ...
    it('displays the default tooltip for the chevron depending on state', function () {
      ...
      var collapsedDescription = wrapper.find(_iconsReact.ChevronDown16).getElements()[0].props['aria-label'];
      ...
      var expandedDescription = wrapper.find(_iconsReact.ChevronDown16).getElements()[0].props['aria-label'];
