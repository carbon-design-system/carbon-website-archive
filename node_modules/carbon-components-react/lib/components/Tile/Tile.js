...
function (_Component4) {
  ...
  _createClass(ExpandableTile, [{
    ...
    value: function render() {
      ...
      var classes = (0, _classnames.default)("".concat(prefix, "--tile"), "".concat(prefix, "--tile--expandable"), _defineProperty({}, "".concat(prefix, "--tile--is-expanded"), this.state.expanded), className);
      var tileStyle = {
