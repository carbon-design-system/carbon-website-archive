  ...
  return (
    ...
    <div className="ibm--grid">
      <div className="ibm--row">
        <nav className={`${prefix}--website-footer__nav ibm--col-lg-2 ibm--col-md-2 ibm--offset-lg-4`}>
          <ul>
            {linksCol1 &&
        ...
        <nav className={`${prefix}--website-footer__nav ibm--col-lg-2 ibm--col-md-2`}>
          <ul>
            {linksCol2 &&
        ...
        <div className={`${prefix}--website-footer__content ibm--col-lg-5 ibm--col-md-4 ibm--offset-lg-3`}>
          {children}
        </div>
      </div>
      <div className="ibm--row">
