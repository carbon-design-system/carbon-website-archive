      ...
      <div className={`${prefix}--homepage-video-container`}>
        <div className={`${prefix}--homepage-video-wrapper`}>
          <VideoInternal
            ...
            <div
              className={`${prefix}--homepage-video-overlay-content bx--grid`}>
              <div
                className={`${prefix}--homepage-video-container-cta bx--row`}>
                <Link
                  className={`${prefix}--homepage-video-cta bx--offset-md-4 bx--col-md-2 bx--offset-lg-8 bx--col-lg-4`}
                  to="/philosophy/">
                ...
                <Link
                  className={`${prefix}--homepage-video-cta bx--col-md-2 bx--col-lg-4`}
                  to="/gallery/">
                  <p className={`${prefix}--type-expressive-heading-03`}>
                    Gallery
                  </p>
