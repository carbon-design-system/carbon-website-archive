...
const RowDecorator = storyFn => <div className='bx--row' style={style}>{storyFn()}</div>;

const CompRowDecorator = storyFn => <div className='bx--row' style={compStyle}>{storyFn()}</div>;
