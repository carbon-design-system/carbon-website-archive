      ...
      <div className={`${prefix}--subfamilies`}>
        <div className={`${prefix}--row ${prefix}--offset-lg-4`}>
          ...
          <div className={classNamesContainer}>
              ...
              <div className={`${prefix}--padding-left-none ${prefix}--padding--horizontal ${prefix}--col-md-4`}>
                <div style={{ fontWeight: 100 }}>Thin</div>
                <div style={{ fontWeight: 100 }} className={`${prefix}--type-italic`}>
                  Thin Italic
                </div>
                <div style={{ fontWeight: 200 }}>ExtraLight</div>
                <div style={{ fontWeight: 200 }} className={`${prefix}--type-italic`}>
                  ExtraLight Italic
                </div>
                <div style={{ fontWeight: 300 }}>Light</div>
                <div style={{ fontWeight: 300 }} className={`${prefix}--type-italic`}>
                  Light Italic
                </div>
                <div style={{ fontWeight: 400 }}>Regular</div>
                <div style={{ fontWeight: 400 }} className={`${prefix}--type-italic`}>
                  Regular Italic
                </div>
              </div>
              <div className={`${prefix}--padding-left-none ${prefix}--padding--horizontal ${prefix}--col-md-4`}>
                <div style={{ fontWeight: 450 }}>Text</div>
                <div style={{ fontWeight: 450 }} className={`${prefix}--type-italic`}>
                  Text Italic
                </div>
                <div style={{ fontWeight: 500 }}>Medium</div>
                <div style={{ fontWeight: 500 }} className={`${prefix}--type-italic`}>
                  Medium Italic
                </div>
                <div style={{ fontWeight: 600 }}>SemiBold</div>
                <div style={{ fontWeight: 600 }} className={`${prefix}--type-italic`}>
                  SemiBold Italic
                </div>
                <div style={{ fontWeight: 700 }}>Bold</div>
                <div style={{ fontWeight: 700 }} className={`${prefix}--type-italic`}>
                  Bold Italic
                </div>
              </div>
            </div>
