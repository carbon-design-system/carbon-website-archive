(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('classnames'), require('carbon-components')) :
  typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'classnames', 'carbon-components'], factory) :
  factory(global.CarbonAddonsWebsite = {},global.React,global.PropTypes,global.ClassNames,global.CarbonComponents);
}(typeof self !== 'undefined' ? self : this, function (exports,React,PropTypes,classnames,carbonComponents) { 'use strict';
  ...
  var WebsiteFooter = function WebsiteFooter(_ref) {
    ...
    return React.createElement("footer", {
      ...
      className: "".concat(prefix, "--website-footer__content ibm--col-lg-5 ibm--col-md-4 ibm--offset-lg-3")
