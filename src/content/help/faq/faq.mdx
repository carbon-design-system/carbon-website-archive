...
### I haven't updated to the latest version of Carbon yet, but I still need the old documentation. Where can I find it?
...
* Version 10 draft in progress and will be posted here when approved

### Where do I find charts and data visualization?

We’re working on a long term solution, including visual guidance and chart components as part of the core Carbon library.

In the meantime, you can use [these resources](https://carbon-design-system.github.io/carbon-charts/?experimental=true) as a starting point for chart needs. We will be updating this with an updated color palette to match the rest of Carbon v10.
