...
### How to make content and metadata changes to your listing

1. Make edits in the [Resource Management Console (RMC) staging environment](test.cloud.ibm.com/onboarding/dashboard). You will need to be listed as a Project Contributor within your RMC entry. The owner of the entry or other contributors can add you. 
2. Preview changes in the [Console staging UI](https://console.test.cloud.ibm.com/catalog/).
3. Notify the IBM Cloud Platform UX governance team (slack channel: #cloud-ux-governance) of your changes for review.
4. When changes have been approved, you can promote your listing to Production from the "Promote to Prod" RMC tab. Once pushed, your changes will be updated in the [Console production UI](https://console.cloud.ibm.com/catalog/).
5. Monitor your analytics on Amplitude to confirm your changes had a positive effect.
