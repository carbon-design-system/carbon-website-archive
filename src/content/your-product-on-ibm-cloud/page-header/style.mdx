...
<ImageComponent cols="12" caption="Page Header Small Specs">
...
<ImageComponent cols="12" caption="Page Header Medium Specs">
...
<ImageComponent cols="12" caption="Page Header Large Specs">
