...
<ImageComponent cols="12" caption="The switcher being used to navigate within an offering.">
...
<ImageComponent cols="12" caption="Breadcrumbs being used to navigate up a level.">
