...
For high-impact scenarios, a user should confirm the action by manually entering the name of the resource. When the resource name is identically matched the 'Delete' button is enabled. 
