...
<ImageComponent cols="12" caption="The IBM Design website using header-only navigation.">
...
<ImageComponent cols="12" caption="Example of the left panel as the global navigation.">
...
<ImageComponent cols="12" caption="The switcher being used to navigate between offerings.">
...
<ImageComponent cols="12" caption="Diagram showing the hierarchy of the global nav.">

![Example of different Shell configurations.](images/within-offering.png)
...
![Example of different Shell configurations.](images/drill-down.png)
