...
- [Grouping and classification of information](#Grouping_and_classification_of_information)
- [Coming soon](#broken)
...
<ImageComponent cols="12" caption="Example of different Shell configurations.">

![Example of different Shell configurations.](images/blank_image_REMOVE.png)
...
<ImageComponent cols="8" caption="Example of a header as the global navigation.">

![Example of a header as the global navigation](images/blank_image_REMOVE.png)
...
<ImageComponent cols="8" caption="Example of the left panel as the global navigation.">
...
<ImageComponent cols="8" caption="Diagram showing the hierarchy of the global nav.">
...
Use the Shell's menu item's to track the essential state elements in the URL and return the user to that URL automatically when they return.
...
## Grouping and classification of information
...
**Audience:**
Be cautions. Tasks may overlap personas - decreasing dicoverability. 
...
#### References:
1. David R. Danielson, Transitional Volatility in Web Navigation (2003)
