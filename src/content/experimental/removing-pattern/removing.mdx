...
![Example of a remove pattern using a modal in context](images/context.png)
...
![Example of a high-impact remove modal](images/first.png)

</ImageComponent>

<ImageComponent cols="8" caption="Example of a high-impact remove modal in its removing state">

![Example of a high-impact remove modal in its 'removing' state](images/second.png)
