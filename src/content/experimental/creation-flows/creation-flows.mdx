...
**Maintainers**: [Vikki Paterson](https://github.ibm.com/VICTORIA), [Arnaud Gillard](https://github.ibm.com/Arnaud-Gillard)
...
<ImageComponent caption="Example of a creation pattern in context." cols="8">
...
<ImageComponent caption="Example of a full page creation flow" cols="8">

![Example of a fill page creation flow](images/8.png)
...
![Example of advanced option toggle](images/9.png)
...
<ImageComponent caption="Example of a multi-step creation flow in a side panel" cols="8">

![Example of a multi-step creation flow in a side panel](images/12.png)

</ImageComponent>

<ImageComponent caption="Example of a multi-step creation flow in a side panel" cols="8">

![Example of a multi-step creation flow in a side panel](images/13.png)

</ImageComponent>

### Full page

<ImageComponent caption="Start of full page multistep creation flow" cols="8">

![Start of full page multistep creation flow](images/14.png)

</ImageComponent>

<ImageComponent caption="Full page multistep creation flow with image" cols="8">

![Full page multistep creation flow with image](images/15.png)

</ImageComponent>

<ImageComponent caption="Full page multistep creation flow with image and right aligned button" cols="8">

![Full page multistep creation flow with image and right aligned button.](images/16.png)
...
![Example of a successful creation confirmation"](images/17.png)
