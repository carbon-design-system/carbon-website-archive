...
<ImageComponent fixed="default" caption="Example of light fields with $field-02 (left) and the default version with $field-01 (right)">
...
<ImageComponent fixed="large" caption="Structure and spacing measurements for a double column form | px / rem">

![Structure and spacing measurements for a double column form ](images/form-style-2.png)

</ImageComponent>

<ImageComponent fixed="large" caption="Structure and spacing measurements for a single column form | px / rem">
