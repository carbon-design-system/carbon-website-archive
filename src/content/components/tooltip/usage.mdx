...
Icon tooltips and interactive tooltips may be positioned **top**, **bottom**, **left**, or **right** to the trigger item. The container of the [definition tooltip](#definition-tooltip) text may be aligned to **start**, **center** or **end**.
