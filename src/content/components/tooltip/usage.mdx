...
Icon tooltips and interactive tooltips may be positioned **above**, **below**, **left**, or **right** to the trigger item. The container of the tooltip text may be aligned to **start**, **center** or **end**.
