...
Icon tooltips and interactive tooltips may be positioned **top**, **below**, **left**, or **right** to the trigger item and the container of the tooltip text may be aligned to **start**, **center** or **end**.
...
The definition tooltip provides additional help or defines an item or term. It may be used on a label of an UI element, or on a word embedded in a paragraph.

<ImageComponent cols="8"  caption="Definition tooltip used within a paragraph.">
...
Interactive tooltips may contain rich text and other interactive elements like buttons or links. Please note that in general hiding interactive content in tooltip is discouraged. Approved example usage of interactive tooltip are for on-boarding experiences and product tours.


<ImageComponent cols="8"  caption="Example of an interactive tooltip in a product walk through.">
