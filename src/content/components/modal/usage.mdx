...
The modal is composed of three distinct zones: A header, the body, and a footer. Components (eg. data table, form, progress indicator) should occupy the full width of the modal. Text, including the paragraph component, should only be 75% of the modal's width.
...
A modal should have minimal body content. Components that may be used in modals include: form fields, text area, select, and radio buttons.
