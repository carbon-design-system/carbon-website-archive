...
The modal is composed of three distinct zones: A header, the body, and a footer. Components (eg. data table, form, progress indicator) should occupy the full width of the modal. 
...
<ImageComponent caption="Example of modal with one button." cols="8">

![Example of modal with one button.](images/modal-usage-4a.png)

</ImageComponent>

<ImageComponent caption="Example of modal with two buttons." cols="8">
