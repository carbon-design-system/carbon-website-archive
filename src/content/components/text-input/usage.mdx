...
<ImageComponent cols="12" caption="An example of a text input.">
...
Text fields and text areas may have a character limit and counter. Use the character limit and counter to let users know how long their entry can be. 

<ImageComponent cols="8" caption="An example of a text area.">

![An example of a text area.](images/text-area-usage-1.png)

</ImageComponent>

While useful for data collection, character count is not an intuitive way to communicate content length to users. Character count allows a user to clearly understand an input error if they surpass the character limit.
