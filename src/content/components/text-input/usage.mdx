...
While useful data collection, character count is not an intuitive way to communicate content length to users. Character count allows a user to clearly understand an input error if they surpass the character limit.
