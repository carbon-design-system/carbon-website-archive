...
<ImageComponent cols="12" caption="UI Shell header example.">
...
<ImageComponent cols="8" caption="Menu-trigger interactive states">
...
<ImageComponent cols="8" caption="Menu item interactive states">
...
<ImageComponent cols="12" caption="Sub-menu interactive states">
...
<ImageComponent cols="8" caption="Header action interactive states">
...
<ImageComponent cols="12" caption="Structure and spacing measurements for UI shell header | px | rem">

![ui shell header spec](images/header-style-2.png)

</ImageComponent>

<ImageComponent cols="12" caption="Structure and spacing measurements for header submenu | px | rem">
...
<ImageComponent cols="12" caption="Responsive behavior for UI shell header">
