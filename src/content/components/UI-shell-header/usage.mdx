...
![UI shell system zone.](images/shell-usage-2.png)
...
|Icon | Role| Order |
|-----|-----|---|
|Search||Search should always be positioned as the furthest left icon. This is to allow for |
|Product determined icons|||
|Help|||
|Notifications|||
|Account|||
|Switcher|||
...
![Header responsive behavior.](images/shell-usage-3.png)
