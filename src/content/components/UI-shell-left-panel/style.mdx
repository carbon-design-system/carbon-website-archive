...
<ImageComponent cols="8"  caption="UI shell side-nav example.">
...
<ImageComponent cols="12"  caption="Link states">
...
<ImageComponent cols="12"  caption="Sub-menu states">
...
<ImageComponent cols="12" caption="Structure and spacing measurements for the side-nav | px | rem.">

![ui shell side-nav](images/left-nav-style-2.png)

</ImageComponent>

<ImageComponent cols="12" caption="Structure and spacing measurements for side-nav with icons | px | rem.">
