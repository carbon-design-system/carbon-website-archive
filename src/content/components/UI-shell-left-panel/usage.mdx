...
Three teirs of navigation in the left navigation menu is not supported. If you have additional content to display beneath a sub-menu, use tabs within the page.
