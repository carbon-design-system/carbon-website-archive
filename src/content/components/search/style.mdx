...
<ImageComponent fixed="default" caption="Example of Search using $field-01">
...
<ImageComponent fixed="default" caption="Examples of enabled, focus, and disabled search states">
...
<ImageComponent fixed="default" caption="Structure and spacing measurements for large search | px | rem">
