...
Carbon components typically use icons on 16px artboards. Icons on 20px, 24px, and 32px artboards can also be used within the UI.
...
<ImageComponent cols="12" caption="16px and 20px icons are optimized to feel balanced when paired with 14pt and 16pt IBM Plex. Use 24px and 32px when larger icons are needed.">
...
<ImageComponent  cols="4" caption="The menu button that is also a touch target may have a 20px ✕ 20px icon centered in a 48px ✕ 48px button.">
...
`carbon-icons` ships with two main SVG files that contain different sets of external SVG sprite files:
