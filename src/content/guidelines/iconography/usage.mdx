...
Carbon components typically use 16px icons. Icons sized at 20px, 24px, and 32px can be also used within the UI.
...
Full installation details can be found in the Carbon icons [GitHub repo](https://github.com/ibm/carbon-icons).
