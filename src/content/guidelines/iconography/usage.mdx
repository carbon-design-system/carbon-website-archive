...
| ----------------- | ------------------------------------------------------------------------------------------------------- | ------------------- |
| _carbon-icons.svg_  | Contains current icons (consolidated subset of legacy icons used in IBM Bluemix)                        | `3.x` and newer     |
| _carbon-icons.json_ | JSON file created from carbon-icons.svg, used in [Carbon](/guidelines/iconography/library)              | `3.x` and newer     |
| _carbon-icons.js_   | JS module created from carbon-icons.svg, used in `Icon` React Component in [carbon-components-react](#) | `3.x` and newer     |
| _sprite.svg_       | SVG sprite contains legacy icons                                                                        | `1.x`,`2.x`and`3.x` |
| _icons.json_       | legacy JSON file created from sprite.svg                                                                | `1.x`,`2.x`and`3.x` |
