...
|                        | SCSS              | HEX y                                                     |
| ---------------------- | ----------------- | --------------------------------------------------------- |
| Primary action         | \$brand-01        | <ColorBlock showhex="true" size="xs">#3d70b2</ColorBlock> |
| Primary action:hover   | \$hover-primary   | <ColorBlock showhex="true" size="xs">#30588C</ColorBlock> |
| Secondary action       | \$ui-05           | <ColorBlock showhex="true" size="xs">#5a6872</ColorBlock> |
| Secondary action:hover | \$hover-secondary | <ColorBlock showhex="true" size="xs">#3d70b2</ColorBlock> |
