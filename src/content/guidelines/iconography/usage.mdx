...
<GridWrapper col_lg="8" flex="true">
    <DoDontExample correct=true label="Do use the correct icon size with IBM Plex.">
...
<GridWrapper col_lg="8" flex="true">
    <DoDontExample correct=true label="Do match your icon color with your text color when pairing them.">
