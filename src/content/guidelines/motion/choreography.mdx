...
<DoDontExample correct label="When removing an item from the grid, thumbnails on the edge existing and re-entering container create a smooth transition.">
...
<Row>
<Column offsetLg="4" lg="4" md="4">
<DoDontExample correct label="When sorting or shuffling items on the grid, always using rounded corner paths to visually organize the movements.">
...
<Row>
<Column offsetLg="4" lg="4" md="4">
<DoDontExample correct label="Use motion to reinforce meaning. Affirmative action here triggers a different exit motion for the modal than negation.">
