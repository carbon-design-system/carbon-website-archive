...
import WebsiteTabs from '../../../../src/components/WebsiteTabs';
import SimpleColumns from '../../../../src/components/SimpleColumns';
...
<ul>
  <li>
    <a data-scroll href="#style">
      Style
    </a>
  </li>
  <li>
    <a data-scroll href="#easing">
      Easing
    </a>
  </li>
  <li>
    <a data-scroll href="#duration">
      Duration
    </a>
  </li>
</ul>
...
<div>
  <p>Productive</p>
  <img
    src="images/Motion_overview_Curves_productive.svg"
...
<div>
  <p>Expressive</p>
  <img
    src="images/Motion_overview_Curves_expressive.svg"
    alt="Curve graphs representing differences between productive and expressive animation curves"
  />
</div>
