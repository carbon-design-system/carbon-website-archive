...
<Row>
<Column offsetLg="4">
<DoDontExample correct="true" label="Productive moments are labeled blue, and Expressive moments are labeled magenta.">
...
<Row>
<Column offsetLg="4" lg="8">
<DoDontExample correct="true" label="Elements on the screen speed up quickly and slow down smoothly, obeying the physics of a light-weight material.">
...
<Row>
<Column offsetLg="4" lg="8">
<DoDontExample correct="false" label="Easing curves that suggest bounce, stretch, or sudden stops are not recommended.">
...
<Row>
<Column offsetLg="4" lg="8">
<DoDontExample correct="true" label="Duration contrast between a taller and a shorter component.">
