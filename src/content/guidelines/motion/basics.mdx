...
<Row>
<Column offsetLg="4">
<DoDontExample correct label="Productive moments are labeled blue, and Expressive moments are labeled magenta.">
...
<DoDontExample correct label="Elements on the screen speed up quickly and slow down smoothly, obeying the physics of a light-weight material.">
