...
| Framework     | Productive                      | Expressive                      |
| ------------- | ------------------------------- | ------------------------------- |
| IBM Motion package | `motion(standard, productive)` | `motion(standard, expressive)` |
...
| Framework     | Productive                    | Expressive                 |
| ------------- | ----------------------------- | -------------------------- |
| IBM Motion package | `motion(entrance, productive)` | `motion(entrance, expressive)` |
...
| Framework     | Productive                   | Expressive                    |
| ------------- | ---------------------------- | ----------------------------- |
| IBM Motion package | `motion(exit, productive)` | `motion(exit, expressive)` |
