...
![White dropdown on a Gray 10 background.](images/Light_theme_revised.png)
...
![White overflow menu on Gray 10 card.](images/Light_theme_03_new.png)
...
<ImageComponent cols="12" caption="Components with common colors across both light themes.">

![icon alignment](images/Light_theme_sample_revised.gif)
...
![White dropdown on a Gray 10 background.](images/Dark_theme_02_rev.png)
...
<ImageComponent cols="12" caption="Components with common colors across both dark UI backgrounds.">

![icon alignment](images/Dark_theme_sample_revised.gif)
...
<ImageComponent cols="12" caption="Light theme interactive tokens.">

![icon alignment](images/Interactive_states_light_new.png)

</ImageComponent>


<ImageComponent cols="12" caption="Dark theme interactive tokens.">

![icon alignment](images/Interactive_states_dark_new.png)
