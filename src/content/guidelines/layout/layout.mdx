...
### It’s fundamental to everything we design. The _2x grid_ is the geometric foundation of all the visual elements of IBM Design, from typography to columns, boxes, icons, and illustrations. It provides structure and guidance for all creative decision-making.
...
The basic unit of 2x grid geometry is the 8-pixel _Mini unit_. Multiples of Mini Units compose the dimensions of columns, rows, boxes, along with their margins and padding. The Mini Unit adapts to your content while maintaining a consistent visual rhythm.
...
- [Fixed base unit](#fixed-base-unit)
- [Fluid base unit](#fluid-base-unit)
- [Scaling multiple](#scaling-multiple)
