...
Carbon v10 is live! This major release includes a host of [enhancements and upgrades](../release-highlights), including the integration of the new IBM Design Language. A comprehensive [Migration Guide](../v10-migration) is available for designers and developers moving from v9 to v10.  
...
We expect v10 to launch in March, so keep your eyes peeled. If you're interested in getting started before our public launch, we're always looking for beta testers to help us squash bugs and improve the Carbon Design System.
...
- [June 4, 2018: V9 release](#june-4,-2018:-v9-release)
