...
[Carbon Components Vanilla Javascript](https://github.com/IBM/carbon-components/blob/master/docs/migration/migrate-to-10.x.md)
[Carbon Components React](https://github.com/IBM/carbon-components-react/blob/master/docs/migration/migrate-to-10.x.md)

Introduction of production ready [Carbon Elements](https://github.com/IBM/carbon-elements) package.

[Carbon Components Angular](https://github.com/ibm/carbon-components-angular) and [Carbon Components Vue](https://github.com/carbon-design-system/carbon-components-vue) are unchanged and not part of this production release.
