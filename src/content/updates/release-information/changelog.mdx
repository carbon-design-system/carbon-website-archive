...
We're excited to announce the latest release of the Carbon Design System, v10.4.0 <span aria-label="celebrate">🥳</span>
...
In addition to these projects, we also introduced general updates to our website and have an ongoing support project for managing issue triage and fixing bugs. Highlights from these projects are detailed below, for a full list of changes, please view the [changelog](#changelog).
...
- Added color theme dropdown in vanilla development environment (https://the-carbon-components.netlify.com) https://github.com/carbon-design-system/carbon/pull/3073
...
- [March 2019: v10 release](#march-2019-v9-release)
- [February 2019](#february-2019)
- [October 2018](#october-2018)
- [June 2018: v9 release](#june-4,-2018:-v9-release)
- [May 2018](#may-16,-2018)
- [March 2018](#march-9,-2018)
- [February 2018](#february-23,-2018)
- [February 2018](#february-9,-2018)
