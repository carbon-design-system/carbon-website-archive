...
A complete contribution ultimately includes the following parts. We encourage you to surface works-in-progress. If you're not able to complete all of the parts yourself, someone in the community may be able to pick up where you left off.
...
See our [production guidelines](https://github.com/carbon-design-system/carbon-website/wiki/Production-guidelines#spec-guidelines) and the [documentation guidelines](/contributions/documentation) for help documenting your work.
