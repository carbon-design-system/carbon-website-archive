...
To contribute a component to Carbon, start by [opening an issue](https://github.com/carbon-design-system/carbon/issues/new?assignees=&labels=type%3A+enhancement+%F0%9F%92%A1&template=feature-request-or-enhancement.md&title=). Include a detailed description that includes the following:
* the rationale
* the intended behavior
* whether it's a variation of an existing component, or a new asset
* mockups, of any fidelity (optional)
* any inspirations from other sites (optional)
