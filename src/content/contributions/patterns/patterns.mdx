...
* Any new patterns or changes to existing patterns will also live in a Sketch kit for patterns and so you will need to create Sketch symbols for components used. 
