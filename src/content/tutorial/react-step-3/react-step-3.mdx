...
This step starts with a React app that has styled static pages. By the end of this step you will have connected to the [GitHub GraphQL API](https://developer.github.com/v4/) and populated the data table component - skeleton loading state and all.
