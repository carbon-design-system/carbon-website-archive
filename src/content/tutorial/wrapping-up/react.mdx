...
Complete the [application form](https://www.surveygizmo.com/s3/5075530/Dev-Essentials-Badge-Application) to request the digital badge. Once you submit the application, please allow 2-4 days for issuing the badge. Once the badge is issued, you will be notified and must accept the badge via Acclaim.
