...
We'll need to add a styling override to move the tabs to the right on large viewports. For that, in `app.scss`, add the breakpoint import at the **top** of the file before we import `landing-page.scss`.
...
Then in `landing-page.scss` add this declaration block.

##### src/content/LandingPage/landing-page.scss
...
##### src/content/RepoPage/repo-page.scss
