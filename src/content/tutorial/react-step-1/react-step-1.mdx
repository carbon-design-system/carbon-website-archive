...
_Note: With this push operation, git may prompt you to authenticate with your git user name or email.  At the password prompt, you will be required to enter a personal access token, not your regular password.  This is because of 2-factor authentication.  You can create a personal access token by visiting https://github.com/settings/tokens and clicking the _`Generate new token`_ button._
