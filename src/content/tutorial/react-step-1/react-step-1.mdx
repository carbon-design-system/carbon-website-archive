...
Or, if you prefer to use HTTPS with your remotes:
...
_Note: When creating navigation headers, it's important to have a_ `Skip to content` _link for accessibility. This allows keyboard users to skip the navigation items and go straight to the main content._
