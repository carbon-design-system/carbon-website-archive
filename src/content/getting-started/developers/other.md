...
title: Developers
tabs: ['Vanilla', 'React', 'Other']
---

<page-intro>The Carbon team currently only officially supports vanilla js and React. However developers using a different javascript framework (such as Angular or Vue) can can follow the instructions for the [Vanilla](/getting-started/developers/vanilla) library to access the styles and build out their own components.</page-intro>
