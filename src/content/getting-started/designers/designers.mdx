...
<GridWrapper col_lg="8" flex="true" bleed="true">
    <ClickableTile
    title="Add the IBM Design Language library"
...
![](/images/sketch-icon.png)
  ...
  <ClickableTile
    title="Add the IBM 2x grid template"
...
2. [**Add libraries**](#design-great-digital-experiences-with-carbon). Designing with Carbon requires three libraries: The IBM Design Language kit, the Carbon kit, and the IBM Design Language grid template. Click the tiles above to install each. All three libraries are required.
    ...
    - The [2x grid template](sketch://add-library/cloud/ngV7z) library comes prepopulated with the IBM Design Language grid, an essenntial tool for layouts and spacial design.

## Set up

To get started with Carbon, familiarize yourself with the contents of each library. You can find a full breakdown of each kit's contents at the bottom of this page.

1. **Find the grid**. At the top of your screen, navigate to `Sketch → Preferences → Libraries`. Find the grid template library, click the eyeball icon, and select "Open with Sketch." From here you can copy and paste the grid into any other Sketch document.
...
![2x grid overview](/Layout_overview_Columns-rows-0302ac75ce345781aa42298affd6184c.svg)
...
<ImageComponent cols="8" caption="Carbon symbol menu navigation">

![Carbon symbol menu navigation](/images/symbol-nav.png)
...
From the main menu select `Insert → Symbols → Carbon Design System` to add symbols onto your page. 
...
Text styles are based on the typography rules that are defined by the IBM Design Language.
...
Carbon offers a full range of layer styles and we discourage creating your own unless absolutely necessary.

If you elect to override a preset layer style, use the existing override styles found in the right-hand panel.
...
We make small adjustments and bug fixes to the kit on a regular basis. These changes are made to the Carbon Sketch kit and you will be notified via a red pop-up in the top right corner of the Sketch window. 
