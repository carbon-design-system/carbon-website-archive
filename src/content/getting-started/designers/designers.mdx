...
Carbon empowers designers to rapidly build beautiful and accessible experiences.
...
All designs should start with the 2x Grid template. Once you have [saved the grid](#gat-the-kit) as a template, navigate to `File → New file from Template` and select the grid template.
...
- For even more configurablility, use the individual building blocks found under the `Items` folder within the component. Be sure your custom design adheres to our [design guidelines](/guidelines/accessibility/overview).
...
Brand new to Sketch? Here are a few tutorials to get you started.
