        ...
        plugins: [
          ...
          'gatsby-remark-copy-linked-files',
          {
            ...
            options: {
              ...
              // default:
              getIframe: url =>
                `<div class="ibm--row"><div class="ibm--col-lg-12 ibm--offset-lg-4"><iframe src="${url}" class="website-codesandbox" sandbox="allow-modals allow-forms allow-popups allow-scripts allow-same-origin"></iframe></div></div>`,
            },
          },
